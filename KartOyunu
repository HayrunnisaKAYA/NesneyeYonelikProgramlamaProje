        ...
        public abstract class Oyun : IOyun
        {
            ...
            private void SonuclariGoster()
            {
                ...
                if (kullanici.KazanilanRaund > bilgisayar.KazanilanRaund)
                {
                    ...
                    // Alkış sesi
                    string alkisDosyasi = @"C:\Users\kayah\Desktop\applause-236785.wav";
                    SoundPlayer player = new SoundPlayer(@"C:\\Users\\kayah\\Desktop\\applause-236785.wav");
                ...
                else if (bilgisayar.KazanilanRaund > kullanici.KazanilanRaund)
                {
                    ...
                    //Kaybetme sesi
                    string KaybetmeDosyasi = @"C:\Users\kayah\Desktop\Aaa - Üzülme Ses Efekti.wav";
                    SoundPlayer player = new SoundPlayer(@"C:\Users\kayah\Desktop\Aaa - Üzülme Ses Efekti.wav");
            ...
            private static void ToplamSonuclariGoster()
            {
                ...
                Console.WriteLine($"Kullanıcı Kazanım Sayısı: {ToplamKullaniciKazanim}");
                Console.WriteLine($"Bilgisayar Kazanım Sayısı: {ToplamBilgisayarKazanim}");
